...
import com.demo.project.exception.CustomerPasswordInvalid;
...
//	}
	...
	@PostMapping
	public Customer addCustomer(@RequestBody Customer customer) throws CustomerAlreadyExists, CustomerNumberInvalid, CustomerEmailInvalid, CustomerPasswordInvalid
	{
